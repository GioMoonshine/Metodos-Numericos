...
MÉTODOS DISPONIBLES:
--------------------
1. Bisección: Método robusto que divide el intervalo por la mitad
2. Regula Falsi: Método que usa interpolación lineal
--------------------

FUNCIONES COMUNES:
------------------
- evaluar_funcion(funcion_str, x): Evalúa la función en x
- verificar_cambio_signo(funcion_str, a, b): Verifica cambio de signo
- mostrar_resultados(...): Muestra los resultados formateados
------------------
